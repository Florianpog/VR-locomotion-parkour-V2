...
{
    public ParkourMovementDetector prkourMovementDetector;
    ...
    void Update()
    {
        ...
        {
            isStageChange = false;
            if (prkourMovementDetector.stage == startBanner.name)
            {
                parkourStart = true;
            ...
            else if (prkourMovementDetector.stage == firstBanner.name)
            {
                firstBanner.SetActive(false);
                firstCoins.SetActive(false);
                objIX1.SetActive(false);
            ...
            else if (prkourMovementDetector.stage == secondBanner.name)
            {
                secondBanner.SetActive(false);
                secondCoins.SetActive(false);
                objIX2.SetActive(false);
            ...
            else if (prkourMovementDetector.stage == finalBanner.name)
            {
                parkourStart = false;
                finalCoins.SetActive(false);
                objIX3.SetActive(false);
